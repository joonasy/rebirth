...
module.exports = function (grunt) {
  grunt.initConfig({
    ...
    path: {
      ...
      tmp: '.tmp',
      template: '/typo3conf/ext/<project-name>_templates'
    },
    meta: {
      banner:
        '/*!\n' +
      ...
      dist: {
        files: {
          ...
          '<%= path.tmp %>/Assets/javascripts/app.js': [
            ...
            '<%= path.private %>/Assets/javascripts/vendor/*.js',
            '!<%= path.private %>/Assets/javascripts/vendor/jquery.min.js',
            '<%= path.private %>/Assets/javascripts/config.js',
            '<%= path.private %>/Assets/javascripts/components/*.js',
            '!<%= path.private %>/Assets/javascripts/components/App.Component.js',
