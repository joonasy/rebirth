!(function() {
...
})()(
  {
    ...
    3: [
      function(n, e, t) {
        var r = n('../internals/to-indexed-object'),
          ...
          o = n('../internals/to-absolute-index'),
          a = function(n) {
      ...
      function(n, e, t) {
        ...
        e.exports = function(n, e) {
          var t,
            ...
            b = n.global,
            v = n.stat;
          if ((t = b ? r : v ? r[g] || s(g, {}) : (r[g] || {}).prototype))
            for (u in e) {
              if (
                ((p = e[u]),
                (f = n.noTargetGet ? (d = i(t, u)) && d.value : t[u]),
                !c(b ? u : g + (v ? '.' : '#') + u, n.forced) && void 0 !== f)
              ) {
    ...
    12: [
      function(n, e, t) {
        'use strict';
        var r = n('../internals/hide'),
          i = n('../internals/redefine'),
          o = n('../internals/fails'),
          a = n('../internals/well-known-symbol'),
          s = n('../internals/regexp-exec'),
          l = a('species'),
          c = !o(function() {
            var n = /./;
            return (
        ...
        e.exports = function(n, e, t, f) {
          ...
          if (!d || !g || ('replace' === n && !c) || ('split' === n && !u)) {
            var b = /./[p],
              v = t(p, ''[n], function(n, e, t, r, i) {
                return e.exec === s
                  ? d && !i
                    ? { done: !0, value: b.call(e, t, r) }
                    : { done: !0, value: n.call(t, e, r) }
                  : { done: !1 };
              }),
              h = v[0],
              x = v[1];
            i(String.prototype, n, h),
              i(
                RegExp.prototype,
                p,
                2 == e
    ...
    15: [
      function(n, e, t) {
        (function(n) {
          ...
          e.exports =
            r(typeof globalThis == t && globalThis) ||
            r(typeof window == t && window) ||
            r(typeof self == t && self) ||
            r(typeof n == t && n) ||
    ...
    21: [
      function(n, e, t) {
        var r,
          i,
          o,
          a = n('../internals/native-weak-map'),
          s = n('../internals/global'),
          l = n('../internals/is-object'),
          c = n('../internals/hide'),
          u = n('../internals/has'),
          f = n('../internals/shared-key'),
          p = n('../internals/hidden-keys'),
          d = s.WeakMap;
        if (a) {
          var g = new d(),
            b = g.get,
        ...
        i('inspectSource', function(n) {
          ...
          (e.exports = function(n, e, t, i) {
            var l = !!i && !!i.unsafe,
              ...
              u = !!i && !!i.noTargetGet;
            'function' == typeof t &&
              ('string' != typeof e || a(t, 'name') || o(t, 'name', e),
              (f(t).source = p.join('string' == typeof e ? e : ''))),
              n !== r
                ? (l ? !u && n[e] && (c = !0) : delete n[e],
                  c ? (n[e] = t) : o(n, e, t))
                : c
                ? (n[e] = t)
                : s(e, t);
        ...
        (c || u) &&
          (l = function(n) {
            var e,
              ...
              l = this;
            return (
              u && (t = new RegExp('^' + l.source + '$(?!\\s)', o.call(l))),
              c && (e = l.lastIndex),
              (r = a.call(l, n)),
    ...
    50: [
      function(n, e, t) {
        ...
        e.exports = function(n, e) {
          if (!r(n)) return n;
          var t, i;
          if (e && 'function' == typeof (t = n.toString) && !r((i = t.call(n))))
            return i;
          if ('function' == typeof (t = n.valueOf) && !r((i = t.call(n))))
            return i;
          if (
            !e &&
    ...
    52: [
      function(n, e, t) {
        var r = n('../internals/global'),
          ...
          l = i('wks');
        e.exports = function(n) {
          return l[n] || (l[n] = (a && s[n]) || (a ? s : o)('Symbol.' + n));
        };
      },
      {
        '../internals/global': 15,
    ...
    53: [
      function(n, e, t) {
        ...
        var r = n('../internals/export'),
          i = n('../internals/array-includes').indexOf,
          o = n('../internals/sloppy-array-method'),
          a = [].indexOf,
    ...
    56: [
      function(n, e, t) {
        'use strict';
        var r = n('../internals/fix-regexp-well-known-symbol-logic'),
          i = n('../internals/an-object'),
          o = n('../internals/to-object'),
          a = n('../internals/to-length'),
          s = n('../internals/to-integer'),
          l = n('../internals/require-object-coercible'),
          c = n('../internals/advance-string-index'),
          u = n('../internals/regexp-exec-abstract'),
          f = Math.max,
          p = Math.min,
          d = Math.floor,
          g = /\$([$&'`]|\d\d?|<[^>]*>)/g,
          b = /\$([$&'`]|\d\d?)/g;
        r('replace', 2, function(n, e, t) {
          return [
            function(t, r) {
              var i = l(this),
                o = null == t ? void 0 : t[n];
              return void 0 !== o ? o.call(t, i, r) : e.call(String(i), t, r);
            },
            function(n, o) {
              var l = t(e, n, this, o);
              ...
              for (var x = []; ; ) {
                ...
                if (null === y) break;
                if ((x.push(y), !v)) break;
                '' === String(y[0]) && (d.lastIndex = c(g, a(d.lastIndex), h));
              }
              for (var m, j = '', w = 0, O = 0; O < x.length; O++) {
                y = x[O];
                for (
                  var S = String(y[0]),
                    k = f(p(s(y.index), g.length), 0),
                    E = [],
                    A = 1;
                  A < y.length;
                  A++
                )
                  E.push(void 0 === (m = y[A]) ? m : String(m));
                var T = y.groups;
                if (b) {
                  var M = [S].concat(E, k, g);
                  void 0 !== T && M.push(T);
                  var P = String(o.apply(void 0, M));
                } else P = r(S, g, k, E, T, o);
                k >= w && ((j += g.slice(w, k) + P), (w = k + S.length));
              }
              return j + g.slice(w);
            },
          ];
          function r(n, t, r, i, a, s) {
            var l = r + n.length,
              c = i.length,
              u = b;
            return (
    ...
    57: [
      function(n, e, t) {
        ...
        var r = n('./javascripts/feature'),
          i = document.documentElement;
        (i.className = i.className.replace(/(^|\s)no-js(\s|$)/, ' has-js ')),
          r.hasTouch
            ? i.classList.add('has-touchevents')
            : i.classList.add('no-touchevents');
      },
      {
