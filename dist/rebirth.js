...
},{"./components/Button":5,"./components/Card":7,"./components/Hero":9,"./components/Navbar":11,"fastclick":1,"jquery":2}],4:[function(require,module,exports){
'use strict';
...
},{"../../javascripts/plugins/classToggle":15}],5:[function(require,module,exports){
'use strict';
...
},{"../../javascripts/fixes/objectFitImage":13,"jquery":2}],7:[function(require,module,exports){
'use strict';
...
},{"../../config":12,"../../javascripts/fixes/objectFitImage":13,"../../javascripts/fixes/objectFitVideo":14,"../../javascripts/utils/userAgents":17,"jquery":2}],9:[function(require,module,exports){
'use strict';
...
},{"./Hero":8}],10:[function(require,module,exports){
'use strict';
...
var _utils = require('../../javascripts/utils');
...
var Navbar = function () {
  function Navbar() {
    ...
    this.$navbar = (0, _utils.$$)('.js-Navbar');
    this.$navTrigger = (0, _utils.$$)('.js-NavbarTrigger');
  }
  ...
  _createClass(Navbar, [{
    ...
    key: 'nav',
    value: function nav() {
      [].forEach.call(this.$navTrigger, function (el) {
        el.addEventListener('click', function (e) {
          var $parent = (0, _utils.closest)(e.target, '.js-Navbar');
      ...
      [].forEach.call(this.$navbar, function (el) {
        el.addEventListener('click', function (e) {
          var isTrigger = e.target.className === 'Navbar-trigger';

          if (isTrigger) {
            var $parent = (0, _utils.closest)(e.target, '.Navbar-item');
...
},{"../../javascripts/utils":16}],11:[function(require,module,exports){
'use strict';
  ...
  function setBackground() {
    _jquery2.default.each($figure, function () {
      ...
      if ('lazySizes' in window && srcset) {
        ...
        var _closestWindowWidth = closest(widths, windowWidth);
